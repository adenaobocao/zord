...
export default function PublicoRankingPage() {
  ...
  return (
    <div className="min-h-screen px-4 py-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-black text-[#f0f0f0] flex items-center gap-2">
          <Trophy size={28} className="text-[#eab308]" /> Ranking
        </h1>
      </div>
        ...
        <div className="flex flex-col gap-2">
          {ranking.map((entry, index) => {
            ...
            return (
              ...
              >
                <span className={cn(
                  'w-12 h-12 rounded-lg flex items-center justify-center font-black text-xl shrink-0',
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[#f0f0f0] font-black text-xl truncate">{entry.player.apelido}</p>
                ...
                <div className="text-right shrink-0">
                  <p className="text-[#8b5cf6] font-black text-3xl">{entry.pontosTotal}</p>
                  <p className="text-[#888] text-[10px] font-bold uppercase">pontos</p>
                </div>
              </div>
            );
          })}
